...
mixin _$Room {
 ...
 int? get id;@JsonKey(name: 'room_type') String? get roomType;@JsonKey(name: 'room_count') int? get roomCount; int? get hotelId; double? get basePrice; String? get hotelName; String? get ownerName; double? get currentPrice; List<ImageModel>? get imageDTOList; String? get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,roomType,roomCount,hotelId,basePrice,hotelName,ownerName,currentPrice,const DeepCollectionEquality().hash(imageDTOList),status);

@override
String toString() {
  return 'Room(id: $id, roomType: $roomType, roomCount: $roomCount, hotelId: $hotelId, basePrice: $basePrice, hotelName: $hotelName, ownerName: $ownerName, currentPrice: $currentPrice, imageDTOList: $imageDTOList, status: $status)';
}
...
@useResult
$Res call({
 int? id,@JsonKey(name: 'room_type') String? roomType,@JsonKey(name: 'room_count') int? roomCount, int? hotelId, double? basePrice, String? hotelName, String? ownerName, double? currentPrice, List<ImageModel>? imageDTOList, String? status
});
...
/// Create a copy of Room
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? roomType = freezed,Object? roomCount = freezed,Object? hotelId = freezed,Object? basePrice = freezed,Object? hotelName = freezed,Object? ownerName = freezed,Object? currentPrice = freezed,Object? imageDTOList = freezed,Object? status = freezed,}) {
...
class _Room implements Room {
   _Room({this.id, @JsonKey(name: 'room_type') this.roomType, @JsonKey(name: 'room_count') this.roomCount, this.hotelId, this.basePrice, this.hotelName, this.ownerName, this.currentPrice, final  List<ImageModel>? imageDTOList, this.status}): _imageDTOList = imageDTOList;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,roomType,roomCount,hotelId,basePrice,hotelName,ownerName,currentPrice,const DeepCollectionEquality().hash(_imageDTOList),status);
...
/// Create a copy of Room
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? roomType = freezed,Object? roomCount = freezed,Object? hotelId = freezed,Object? basePrice = freezed,Object? hotelName = freezed,Object? ownerName = freezed,Object? currentPrice = freezed,Object? imageDTOList = freezed,Object? status = freezed,}) {
  return _then(_Room(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,roomType: freezed == roomType ? _self.roomType : roomType // ignore: cast_nullable_to_non_nullable
as String?,roomCount: freezed == roomCount ? _self.roomCount : roomCount // ignore: cast_nullable_to_non_nullable
