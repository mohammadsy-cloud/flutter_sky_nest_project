...
class BrowseAirportCard extends StatelessWidget {
  const BrowseAirportCard({super.key, required this.airport});
              ...
              children: [
                Row(
                  ...
                  children: [
                    RatingBar(
                      ...
                      initialRating: airport.avgRating ?? 0.0,
                ...
                Row(
                  children: [
                    ...
                    Text(airport.location ?? 'No address'),
                  ],
                ),
              ],
            ),
